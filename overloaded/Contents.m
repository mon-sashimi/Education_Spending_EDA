% Mapping Toolbox
% Version 5.0 (R2020b) 18-May-2020
%
% GEOSPATIAL DATA IMPORT AND ACCESS
%  Note: I had to overload a couple of the files (makesymbolspec.m and
%     map.graphics.internal.isValidSymbolSpec.m) because they were checking
%     for graphic object properties in a silly way from a hard-coded
%     enumeration rather than using Matlab's own built-in methods for 
%     checking object properties. Make sure that this is added to the
%     search path if trying to work with any of the gfx__ functions that
%     deal with spatial data; if you run index.mlx first it should add this
%     folder to the path automatically.
%
