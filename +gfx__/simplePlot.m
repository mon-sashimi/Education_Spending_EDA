...
if nargin < 1
   error(['gfx__:' mfilename ':TooFewInputs'],...
      ['\n\t\t->\t<strong>[GFX__.SIMPLEPLOT]:</strong> ' ...
...
% Do "special" parsing to remove 'XTol' and 'YTol'; rest should be standard
% optional <'Name',value> pairs as would typically be provided to `plot`
